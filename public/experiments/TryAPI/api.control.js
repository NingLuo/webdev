(function(){
    ...
    function DoctorCtrl($scope, $http){
        ...
        var resource_url = "https://api.betterdoctor.com/2014-09-12/doctors?specialty_uid=cardiologist&location=42.3611,-71.0577,20&skip=0&limit=10&user_key=" + api_key;
